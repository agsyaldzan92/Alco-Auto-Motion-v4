...
export const SAMPLE_VIDEOS: SampleVideoOption[] = [
  {
    id: 'sample-alco-ecosystem-solution',
    title: 'ALCO Ecosystem - UGC Creator Solusi Praktis (8s)',
    duration: 8.0,
    contentType: 'reels_tiktok',
    description: 'Video 9:16 vertical medium close-up shot creator menunjukkan smartphone dan antarmuka ALCO Ecosystem dengan senyum antusias.',
    goal: 'Mengenalkan kemudahan dan solusi all-in-one dari ALCO Ecosystem untuk ide produk, strategi, dan promosi',
    cta: 'Gak perlu bingung lagi, tinggal ikutin aja di ALCO Ecosystem!',
    thumbnail: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&auto=format&fit=crop&q=80',
    videoUrl: 'https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4',
    rawTranscript: `Tenang! Aku nemu solusinya nih, namanya ALCO Ecosystem!
Ini tuh beneran bantu aku banget.
Dari ide produk, strategi, sampai materi promosi, semua udah siap di sana.
Gak perlu bingung lagi, tinggal ikutin aja!`,
    prebuiltSegments: [
      {
        id: 1,
        start: 0.0,
        end: 2.6,
        text: 'Tenang! Aku nemu solusinya nih, namanya ALCO Ecosystem!'
      },
      {
        id: 2,
        start: 2.6,
        end: 4.8,
        text: 'Ini tuh beneran bantu aku banget.'
      },
      {
        id: 3,
        start: 4.8,
        end: 6.8,
        text: 'Dari ide produk, strategi, sampai materi promosi, semua udah siap di sana.'
      },
      {
        id: 4,
        start: 6.8,
        end: 8.0,
        text: 'Gak perlu bingung lagi, tinggal ikutin aja!'
      }
    ],
    defaultUserAssets: [
      {
        id: 'asset-alco-eco-1',
        name: 'ALCO Ecosystem Mobile Interface',
        url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&auto=format&fit=crop&q=80',
        type: 'dashboard',
        label: 'ALCO Ecosystem Dashboard',
      },
      {
        id: 'asset-alco-eco-2',
        name: 'Product & Promo Strategy Workflow',
        url: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&auto=format&fit=crop&q=80',
        type: 'product',
        label: 'Strategy & Promo Toolkit',
      },
    ]
  },
  {
